...
import { todosen } from '../storeMobx/todossync';
...
const SyncMobx = observer(() => {
  ...
  const filteredData = todosen.data
    ?.filter((el) => {
              ...
              filteredData?.map((el) => (
                <TableRow key={el.id} hover>
                  ...
                  <TableCell align="center">
                    ...
                    <IconButton color="error" onClick={() => todosen.deleteuser(el.id)}>
                      <DeleteIcon />
                    </IconButton>
                    <IconButton
                      color={el.status ? 'default' : 'success'}
                      onClick={() => todosen.chexbox(el.id)}
                    >
